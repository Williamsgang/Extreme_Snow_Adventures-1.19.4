...
package net.esa.extremesnowadventures.client.screens.hot;
...
public class BodyTempHot1Overlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (true) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("pjibby:textures/screens/temp_blank.png"));
			...
			RenderSystem.setShaderTexture(0, new ResourceLocation("pjibby:textures/screens/temp_hot.png"));
