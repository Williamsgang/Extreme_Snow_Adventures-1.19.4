	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (true) {
			RenderSystem.setShaderTexture(0,
					new ResourceLocation("extremesnowadventures:textures/screens/temp/temp_blank.png"));
			...
			RenderSystem.setShaderTexture(0,
					new ResourceLocation("extremesnowadventures:textures/screens/temp/hottt.png"));
			Minecraft.getInstance().gui.blit(event.getPoseStack(), posX + 45, posY + 68, 0, 0, 8, 8, 8, 8);

			RenderSystem.setShaderTexture(0,
					new ResourceLocation("extremesnowadventures:textures/screens/temp/temp_cold.png"));
