...
public class WaterBar1Overlay {
    ...
    public static void eventHandler(RenderGuiEvent.Pre event) {
        ...
        if (WaterBarConditionsProcedures.executeWaterBarCondition1(entity)) {
            ...
            GuiComponent.blit(event.getPoseStack(), posX + -213, posY + -120, 0, 0, 8, 8, 8, 8);
