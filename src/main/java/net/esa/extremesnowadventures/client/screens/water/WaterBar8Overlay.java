...
public class WaterBar8Overlay {
    ...
    public static void eventHandler(RenderGuiEvent.Pre event) {
        ...
        if (WaterBarConditionsProcedures.executeWaterBarCondition8(entity)) {
            RenderSystem.setShaderTexture(0, new ResourceLocation("pjibby:textures/screens/waterfull"));
            ...
            RenderSystem.setShaderTexture(0, new ResourceLocation("pjibby:textures/screens/emptybottle"));
